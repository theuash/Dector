...
template <> constexpr inline auto EffectsPanel::qt_create_metaobjectdata<qt_meta_tag_ZN12EffectsPanelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'paramChanged'
        QtMocHelpers::SignalData<void(const QString &, const QString &, const QString &, double)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
        ...
        QtMocHelpers::SignalData<void(const QString &, const QString &, int)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 }, { QMetaType::QString, 4 }, { QMetaType::Int, 8 },
        }}),
    };
...
void EffectsPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->paramChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<double>>(_a[4]))); break;
        case 1: _t->blendChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[3]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (EffectsPanel::*)(const QString & , const QString & , const QString & , double )>(_a, &EffectsPanel::paramChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (EffectsPanel::*)(const QString & , const QString & , int )>(_a, &EffectsPanel::blendChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void EffectsPanel::paramChanged(const QString & _t1, const QString & _t2, const QString & _t3, double _t4)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2, _t3, _t4);
}

// SIGNAL 1
void EffectsPanel::blendChanged(const QString & _t1, const QString & _t2, int _t3)
{
